...
<script type="text/javascript">
  function cekform(){
    if($('#code').val()==""){
      ...
      return false;
        ...
        var cek_code = $.ajax({
                            url : '<?=base_url() ?>index.php/SalesOrder/CekKode/'+$('#code').val()+'/null',
                            type: 'get',
  ...
  <div class="content-wrapper" style="margin-bottom: -30px">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <form class="box" name="frm" onsubmit="return cekform()" enctype="multipart/form-data" method="POST" action="<?php echo base_url()?>index.php/SalesOrder/CreateDb">
                    ...
                    <div class="well well-sm">
                      <div class="row" style="margin: 0px;height: 200px">
                        <div class="form-group" style="margin-bottom:5px;">
                          <input type="text" name="code" id="code" class="form-control" placeholder="Code" value="<?= $code ?>" >
                        </div>
                        <div class="form-group" style="margin-bottom:5px;">
                          <div class="input-group date" id="date_div" style="width:100%!important;">
                            ...
                            <input type="text" name="date" id="date" placeholder="Date" value="<?= date("Y-m-d H:i", strtotime('0 hours')) ?>" class="form-control" />
                          </div>
                        </div>
                        <div class="form-group" style="margin-bottom:5px;">
          ...
          <div class="col-xs-8">
            <div class="form-horizontal">
              ...
              <div class="form-group form-group-lg">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" style="text-align: right;font-weight: bold;" id="payment_modal_paid" onchange="calculate_payment()" value="0">
                </div>
              </div>
              <div class="form-group form-group-lg">
